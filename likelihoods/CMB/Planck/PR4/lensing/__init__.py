...
class likelihood:
    ...
    def __init__(self, lkl_input):
        ...
        self.covmat_cl = "PP"
        self.covmat_fiducial = planck_pr4_root + "pp_consext8_npipe_smicaed_TiPi_jTP_pre30T_kfilt_rdn0cov_PS1_cov.dat"

        self.linear_correction_fiducial_file = planck_pr4_root + "pp_consext8_npipe_smicaed_TiPi_jTP_pre30T_kfilt_rdn0cov_PS1_lensing_fiducial_correction.dat"
        self.linear_correction_bin_window_files = planck_pr4_root + "pp_consext8_npipe_smicaed_TiPi_jTP_pre30T_kfilt_rdn0cov_PS1_lens_delta_window/window%u.dat"
        self.linear_correction_bin_window_in_order = ["TT", "EE", "TE", "PP"]
        self.linear_correction_bin_window_out_order =  ["PP", "PP", "PP", "PP"]
