...
# from https://arxiv.org/abs/2202.04077

class likelihood:
    def __init__(self, lkl_input):
        ### Path to Pantheon Plus likelihood folder (i.e. the folder this file is in)
        path_to_data = os.path.dirname(os.path.realpath(sys.argv[0]))
        path_to_data += '/likelihoods/BG/SN/PantheonPlus/'
        data_file = path_to_data + "Pantheon+SH0ES.dat"
        covmat_file =  path_to_data + "Pantheon+SH0ES_STAT+SYS.cov"
